                            ...
                            <div class="nk-tb-col tb-col-sm">
                                <div class="user-card">
                                    <div class="user-avatar sm bg-warning-dim">
                                        <img src="dashboard_asset/images/avatar/b-sm.jpg" alt="">
                                    </div>
                                    <div class="user-name">
                ...
                <div class="card h-100">
                    <div class="card-inner">
                        ...
                        <ul class="nk-top-products">
                            <li class="item">
                                <div class="thumb">
                                    <img src="dashboard_asset/images/product/a.png" alt="">
                                </div>
                                <div class="info">
                            ...
                            <li class="item">
                                <div class="thumb">
                                    <img src="dashboard_asset/images/product/b.png" alt="">
                                </div>
                                <div class="info">
                            ...
                            <li class="item">
                                <div class="thumb">
                                    <img src="dashboard_asset/images/product/c.png" alt="">
                                </div>
                                <div class="info">
                            ...
                            <li class="item">
                                <div class="thumb">
                                    <img src="dashboard_asset/images/product/d.png" alt="">
                                </div>
                                <div class="info">
                            ...
                            <li class="item">
                                <div class="thumb">
                                    <img src="dashboard_asset/images/product/e.png" alt="">
                                </div>
                                <div class="info">
