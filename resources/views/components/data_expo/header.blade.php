        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto justify-content-end flex-grow-1">
                    ...
                    <li class="nav-item">
                        <a class="nav-link scrollto" href="/">Tentang EPIM</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link scrollto" href="/">Informasi</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link scrollto" href="/">Pendaftaran</a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link scrollto" href="javascript:void(0)">Data Expo</a>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a href="/" class="dropdown-item">Media Partner</a>
                            <a href="/" class="dropdown-item">Sponsor</a>
                        </div>
                    </li>
                </ul>
            </div>
